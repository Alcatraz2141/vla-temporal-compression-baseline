...
1. Train age-gated ablation (strating from 30 epochs, same recipe):
...
**GPU and batch size:**
- Use batch_size: 64 currently on RTX PRO 4500 (32GB) 
...
Currently we have checkpoint of 30 epoch iguess check it start from there once done let me know also before starting let me know if understood what we have so far and what needs to be done ahead.
